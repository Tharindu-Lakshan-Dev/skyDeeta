          ...
          {/* Right Column - Image */}
            ...
            >
              ...
              <div className="relative w-full aspect-[4/3] bg-gradient-to-br from-primary-blue to-accent-cyan trans p-4 rounded-2xl shadow-glass overflow-hidden">
                ...
                <div className="absolute bottom-6 left-6 right-6 p-4 bg-secondary-white/85 rounded-lg">
            ...
            >
             ...
             <motion.div 
              className="absolute -left-4 bottom-1/4 bg-secondary-white/85 mb-2 py-2 px-4 rounded-lg shadow-lg border border-accent-silver/30"
              initial={{ opacity: 0, x: -20 }}
              animate={{ opacity: 1, x: 0 }}
